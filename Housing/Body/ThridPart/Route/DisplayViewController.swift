...
class DisplayViewController: UIViewController, MAMapViewDelegate {
    ...
    func initToolBar() {
        ...
        let playButtonItem: UIBarButtonItem = UIBarButtonItem(image: UIImage.imageWithASName("icon_play"), style: .done, target: self, action: #selector(DisplayViewController.actionPlayAndStop))
    ...
    func actionPlayAndStop() {
        ...
        if isPlaying {
            navigationItem.rightBarButtonItem!.image = UIImage.imageWithASName("icon_stop")
            ...
            navigationItem.rightBarButtonItem!.image = UIImage.imageWithASName("icon_play")
    ...
    func coordinateHeading(_ from: CLLocationCoordinate2D, to: CLLocationCoordinate2D) -> Double {
    ...
    func mapView(_ mapView: MAMapView, viewFor annotation: MAAnnotation) -> MAAnnotationView? {
        ...
        if annotation.isEqual(myLocation) {
            ...
            poiAnnotationView?.image = UIImage.imageWithASName("aeroplane")
